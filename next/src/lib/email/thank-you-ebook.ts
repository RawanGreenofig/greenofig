  ...
  <body style="margin:0;padding:0;background:#f6f9f5;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Helvetica,Arial,sans-serif;color:#1f2937;">
    <div style="max-width:560px;margin:0 auto;padding:32px 24px;">
      ...
      <div style="background:#ffffff;border:1px solid #e5e7eb;border-radius:16px;padding:32px;">
        ...
        <p style="margin:0 0 16px;font-size:15px;line-height:1.6;">
          <strong>Coach Rawan Othman</strong>, our lead clinical nutritionist,
...
What happens next
Coach Rawan Othman, our lead clinical nutritionist, will personally review your answers and reach out within 1-2 business days to schedule your free 20-minute intro call. No pressure, no commitment.
