/**
 * Greenofig blog seed — 10 articles authored by Dr. Rawan Othman.
 *
 ...
 *   :::tip ... :::    — renders a "Dr. Rawan's Tip" callout box
...
const article1: BlogArticle = {
  ...
  title: "How to Start Eating Healthy: A Complete Beginner's Guide by Dr. Rawan Othman",
  titleAr: 'كيف تبدأ الأكل الصحي: دليل شامل للمبتدئين',
  metaDescription:
    "Stop overthinking and start eating better today. Dr. Rawan Othman's evidence-based beginner's guide to building healthy habits that actually last.",
  metaDescriptionAr:
    'توقّف عن التعقيد وابدأ التغذية الصحية اليوم. دليل د. روان عثمان المبني على الأدلة لبناء عادات صحية تدوم فعلاً.',
  ...
  category: 'nutrition',
  keywords: ['how to eat healthy', 'healthy eating guide', 'nutrition for beginners', 'Dr. Rawan Othman'],
  readTimeMinutes: 7,
...
## Dr. Rawan's personal tip: the "next meal" rule
...
## نصيحة د. روان الشخصية: قاعدة "الوجبة القادمة"
...
[Consult Dr. Rawan before starting](/bookings) if you have any chronic condition or take medication. Some medications need food.
...
[استشيري د. روان قبل البدء](/bookings) إذا كان لديك أي حالة مزمنة أو تأخذ دواءً. بعض الأدوية تحتاج طعاماً.
...
If meal prep still feels overwhelming, [get a custom meal plan from Dr. Rawan](/dashboard/meal-plan). I'll match your time, budget, kitchen size, and food preferences — and tell you exactly what to cook each Sunday.
...
إن بقي تحضير الوجبات مرهقاً، [احصلي على خطة وجبات شخصية من د. روان](/dashboard/meal-plan). سأطابق وقتك، ميزانيتك، حجم مطبخك، وتفضيلاتك الغذائية — وأخبرك بالضبط ماذا تطبخين كل أحد.
...
We curate options at [Dr. Rawan's store](/store) with these checks already done.

## Dr. Rawan's recommended daily stack
...
If you have hypothyroidism, PCOS, autoimmune conditions, anemia, fatigue that won't lift, or hair loss — supplement protocols need to be personalized to your bloodwork. [Get personalized advice from Dr. Rawan](/bookings) before spending hundreds on the wrong stack.
...
ننتقي خيارات في [متجر د. روان](/store) مع هذه الفحوصات منجزة.

## كومة د. روان اليومية الموصى بها
...
إن كان لديك خمول الغدة الدرقية، PCOS، حالات مناعة ذاتية، فقر دم، تعب لا يرتفع، أو تساقط شعر — بروتوكولات المكملات تحتاج للتخصيص حسب فحوصاتك. [احصل على نصيحة شخصية من د. روان](/bookings) قبل صرف مئات على الكومة الخطأ.
