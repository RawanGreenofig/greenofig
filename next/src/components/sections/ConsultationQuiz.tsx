      ...
      <div className="max-w-3xl mx-auto">
        <header className="text-center mb-10">
          ...
          <p className="mt-3 text-sm text-fg-2 max-w-lg mx-auto leading-relaxed">
            {isAr
              ? '15 سؤالاً سريعاً تساعدنا في فهم احتياجاتك. ستحصل على كتاب إلكتروني مجاني، وستتواصل معك كوتش روان شخصياً خلال يوم أو يومين.'
              : '15 quick questions help us understand your needs. You get a free ebook, and Coach Rawan personally reaches out within 1–2 business days.'}
          </p>
        </header>
