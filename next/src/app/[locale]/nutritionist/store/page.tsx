...
const SEED: Product[] = [
  ...
  { id: 'p7',  name: 'Eat Real — Nutritionist Coach Rawan',        category: 'books',       price: 18, stock: 12, description: 'Hardback first edition. Signed copies available.',   drNote: 'My take on Mediterranean eating, written for Arab kitchens.', drPick: true, visible: true,  hue: 'rgb(61 122 74 / 0.22)' },
]
