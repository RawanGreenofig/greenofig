...
export const metadata: Metadata = {
  title: 'Coach Rawan Othman | Certified Clinical Nutritionist | Greenofig',
  description:
    'Meet Coach Rawan Othman, head coach at Greenofig and certified clinical nutritionist. 3 years of practice, 500+ clients, evidence-based personalized nutrition.',
  alternates: { canonical: 'https://greenofig.com/coach-rawan-othman' },
  openGraph: {
    url: 'https://greenofig.com/coach-rawan-othman',
    title: 'Coach Rawan Othman | Certified Clinical Nutritionist',
    description:
 ...
 * target that ranks for branded searches like "Coach Rawan Othman"
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
        ...
        <section className="mt-12 md:mt-16 max-w-3xl">
          <h2 className="font-display font-bold text-2xl text-fg-1 mb-4">
            {isAr ? 'عن كوتش روان' : 'About Coach Rawan'}
          </h2>
        ...
        >
          <h2 className="font-display font-bold text-2xl md:text-3xl text-fg-1 mb-3 tracking-tight">
            {isAr
              ? 'ابدأ رحلتك مع كوتش روان'
              : 'Start your journey with Coach Rawan'}
          </h2>
