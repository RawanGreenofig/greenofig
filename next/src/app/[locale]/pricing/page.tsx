  ...
  en: [
    {
      ...
      missing: [
        ...
        'Direct messaging with Nutrition Coach Rawan',
      ],
    },
    {
      name: 'Basic',
    ...
    },
    {
      ...
      currency: 'USD',
      description: 'Personalized plans and direct access to Nutrition Coach Rawan',
      cta: 'Start Premium',
  ...
  ar: [
    {
      ...
      features: [
        '3 مسح غذائي يومياً',
        'مشاهدة منشورات كوتش التغذية روان',
        'تصفح المتجر',
      ...
      missing: [
        ...
        'تتبع التغذية',
        'خطط وجبات مخصصة',
        'التواصل المباشر مع كوتش التغذية روان',
      ],
    },
    {
      name: 'أساسي',
    ...
    },
    {
      ...
      price: { monthly: 49.99, annual: 39.99 },
      currency: 'USD',
      description: 'خطط مخصصة ووصول مباشر لكوتش التغذية روان',
      cta: 'ابدأ المميز',
      href: '/sign-up?plan=premium',
      featured: true,
      badge: 'الأكثر شعبية',
      ...
      features: [
        'كل ما في الأساسي',
        'خطة وجبات مخصصة من كوتش التغذية روان',
        'مساعد التغذية الذكي',
        'تحليلات صحية متقدمة',
        'تتبع النوم والمكملات',
        'قوائم تسوق تلقائية',
        '✉️ تواصل مباشر مع كوتش التغذية روان',
...
const FAQS = {
  en: [
    ...
    },
    {
      ...
      a: 'Premium and VIP members can send private messages directly to Nutrition Coach Rawan and receive personal replies.',
    },
    {
  ...
  ar: [
    ...
    },
    {
      ...
      a: 'يمكن لأعضاء المميز وVIP إرسال رسائل خاصة مباشرة إلى كوتش التغذية روان وتلقي ردود شخصية.',
    },
    {
...
const COPY = {
  en: {
    ...
    guaranteeAttr: '— Nutrition Coach Rawan Othman',
  },
  ar: {
    eyebrow: 'أسعار بسيطة',
    ...
    guaranteeAttr: '— كوتش التغذية روان عثمان',
  },
}
