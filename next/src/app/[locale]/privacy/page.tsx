    ...
    return (
      ...
      >
        ...
        <P>
          ...
          راسلنا على privacy@greenofig.com لتقديم أي طلب.
        </P>
        ...
        <H2>التواصل</H2>
        <P>لأي سؤال حول الخصوصية: privacy@greenofig.com</P>
      </SimplePage>
    )
  }
  ...
  return (
    <SimplePage title="Privacy Policy" subtitle="Last updated: 4 May 2026">
      ...
      <P>
        ...
        delete your account entirely. Email privacy@greenofig.com to make any request.
      </P>
      ...
      <H2>Contact</H2>
      <P>For any privacy question: privacy@greenofig.com</P>
    </SimplePage>
  )
}
