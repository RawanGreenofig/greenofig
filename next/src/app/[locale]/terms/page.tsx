  ...
  if (isAr) {
    return (
      <SimplePage title="شروط الخدمة" subtitle="آخر تحديث: 4 مايو 2026" isAr>
        ...
        <H2>الخدمة</H2>
        <P>
          غرينوفيغ منصة تغذية رقمية تقدّم خطط طعام شخصية، مساعداً ذكياً، استشارات مع كوتش التغذية روان
  ...
  return (
    <SimplePage title="Terms of Service" subtitle="Last updated: 4 May 2026">
      ...
      <P>
        ...
        assistant, consultations with Nutrition Coach Rawan Othman, and supplement products. The service is
