...
const SEED: AdminPost[] = [
  { id: 'p1', title: 'Why protein at breakfast changes your day', authorName: 'Nutritionist Coach Rawan Othman', authorInitials: 'RO', authorRole: 'nutritionist', category: 'tip',          status: 'published', publishedISO: '2026-04-29T08:00:00Z', views: 1842, likes: 312, comments: 47, pinned: true,  hue: 'rgb(163 230 53 / 0.18)' },
  { id: 'p2', title: 'The PCOS plate, simplified',                authorName: 'Nutritionist Coach Rawan Othman', authorInitials: 'RO', authorRole: 'nutritionist', category: 'article',      status: 'published', publishedISO: '2026-04-22T08:00:00Z', views: 2104, likes: 412, comments: 88, pinned: false, hue: 'rgb(6 182 212 / 0.18)' },
  { id: 'p3', title: 'Ramadan kit drop — limited',                authorName: 'Nutritionist Coach Rawan Othman', authorInitials: 'RO', authorRole: 'nutritionist', category: 'announcement', status: 'scheduled', publishedISO: '2026-05-12T07:00:00Z', views: 0,    likes: 0,   comments: 0,  pinned: false, hue: 'rgb(232 145 42 / 0.18)' },
  { id: 'p4', title: 'Salmon bowl variation',                     authorName: 'Nutritionist Coach Rawan Othman', authorInitials: 'RO', authorRole: 'nutritionist', category: 'recipe',       status: 'draft',     publishedISO: '',                       views: 0,    likes: 0,   comments: 0,  pinned: false, hue: 'rgb(132 204 22 / 0.18)' },
  ...
  { id: 'p6', title: 'How to read a Greek yogurt label',          authorName: 'Nutritionist Coach Rawan Othman', authorInitials: 'RO', authorRole: 'nutritionist', category: 'tip',          status: 'published', publishedISO: '2026-04-08T08:00:00Z', views: 1408, likes: 198, comments: 21, pinned: false, hue: 'rgb(101 163 13 / 0.18)' },
  { id: 'p7', title: 'Laila lost 8 kg without giving up dessert', authorName: 'Nutritionist Coach Rawan Othman', authorInitials: 'RO', authorRole: 'nutritionist', category: 'story',        status: 'draft',     publishedISO: '',                       views: 0,    likes: 0,   comments: 0,  pinned: false, hue: 'rgb(168 85 247 / 0.16)' },
  { id: 'p8', title: '20-min weeknight dinners',                  authorName: 'Nutritionist Coach Rawan Othman', authorInitials: 'RO', authorRole: 'nutritionist', category: 'tip',          status: 'published', publishedISO: '2026-03-22T08:00:00Z', views: 1124, likes: 175, comments: 18, pinned: false, hue: 'rgb(232 145 42 / 0.16)' },
]
