...
export default function AdminSiteEditorPage() {
  ...
  const [pricing, setPricing] = useState<PricingTier[]>([
    ...
    { name: 'VIP',     monthlyJod: 49, yearlyJod: 490,  tagline: 'Concierge',      features: 'Direct messages with Nutritionist Coach Rawan\n15% store discount\nMonthly 1:1 review' },
  ])
  const [faq, setFaq] = useState<FaqRow[]>([
    { id: 'f1', question: 'Is the meal plan customized for my body?',                  answer: 'Yes — Nutritionist Coach Rawan personalizes every plan after your intake form and intro call.' },
