...
const SEED: AuditEvent[] = [
  ...
  { id: 'e3',  hoursAgo: 4,   actor: 'Coach Rawan Othman', actorInitials: 'RO', action: 'post_pinned',          target: 'Why protein at breakfast', ip: '94.187.41.6',  severity: 'info' },
  ...
  { id: 'e5',  hoursAgo: 9,   actor: 'Coach Rawan Othman', actorInitials: 'RO', action: 'moderation_resolved',  target: 'Spam: "Buy these…"',       ip: '94.187.41.6',  severity: 'info',   payload: { action: 'removed' } },
