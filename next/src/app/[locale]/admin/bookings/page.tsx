...
const SEED: AdminBooking[] = [
  { id: 'b1',  type: 'followUp', client: 'Layla Hijazi',     clientInitials: 'LH', clientEmail: 'layla@example.com',  nutritionist: 'Coach Rawan Othman', nutritionistInitials: 'RO', scheduledISO: '2026-05-08T15:30', durationMin: 30, status: 'scheduled' },
  { id: 'b2',  type: 'deepDive', client: 'Maya Khalil',      clientInitials: 'MK', clientEmail: 'maya@example.com',   nutritionist: 'Coach Rawan Othman', nutritionistInitials: 'RO', scheduledISO: '2026-05-09T11:00', durationMin: 60, status: 'scheduled' },
  { id: 'b3',  type: 'introCall', client: 'Yousef Abu Shaer', clientInitials: 'YA', clientEmail: 'yousef@example.com', nutritionist: 'Coach Rawan Othman', nutritionistInitials: 'RO', scheduledISO: '2026-05-09T09:30', durationMin: 20, status: 'scheduled' },
  { id: 'b4',  type: 'followUp', client: 'Tareq Sukkar',     clientInitials: 'TS', clientEmail: 'tareq@example.com',  nutritionist: 'Coach Rawan Othman', nutritionistInitials: 'RO', scheduledISO: '2026-05-05T14:00', durationMin: 30, status: 'completed' },
  { id: 'b5',  type: 'deepDive', client: 'Diana Costa',      clientInitials: 'DC', clientEmail: 'diana@example.com',  nutritionist: 'Coach Rawan Othman', nutritionistInitials: 'RO', scheduledISO: '2026-05-04T16:00', durationMin: 60, status: 'completed' },
  { id: 'b6',  type: 'followUp', client: 'Rasha Tarawneh',   clientInitials: 'RT', clientEmail: 'rasha@example.com',  nutritionist: 'Coach Rawan Othman', nutritionistInitials: 'RO', scheduledISO: '2026-05-04T10:30', durationMin: 30, status: 'completed' },
  { id: 'b7',  type: 'introCall', client: 'Omar Saadeh',     clientInitials: 'OS', clientEmail: 'omar@example.com',   nutritionist: 'Coach Rawan Othman', nutritionistInitials: 'RO', scheduledISO: '2026-04-29T11:00', durationMin: 20, status: 'noShow' },
  { id: 'b8',  type: 'followUp', client: 'Hala Mansour',     clientInitials: 'HM', clientEmail: 'hala@example.com',   nutritionist: 'Coach Rawan Othman', nutritionistInitials: 'RO', scheduledISO: '2026-04-26T15:00', durationMin: 30, status: 'cancelled' },
  { id: 'b9',  type: 'followUp', client: 'Karim Jubran',     clientInitials: 'KJ', clientEmail: 'karim@example.com',  nutritionist: 'Coach Rawan Othman', nutritionistInitials: 'RO', scheduledISO: '2026-04-22T13:30', durationMin: 30, status: 'completed' },
  { id: 'b10', type: 'introCall', client: 'Nour Bishara',    clientInitials: 'NB', clientEmail: 'nour@example.com',   nutritionist: 'Coach Rawan Othman', nutritionistInitials: 'RO', scheduledISO: '2026-04-19T10:00', durationMin: 20, status: 'completed' },
]
