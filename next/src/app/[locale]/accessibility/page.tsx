  ...
  if (isAr) {
    return (
      <SimplePage title="إمكانية الوصول" subtitle="آخر تحديث: 4 مايو 2026" isAr>
        ...
        <P>
          إن واجهت أي عائق يمنعك من استخدام الموقع، راسلنا على access@greenofig.com.
  ...
  return (
    <SimplePage title="Accessibility" subtitle="Last updated: 4 May 2026">
      ...
      <P>
        ...
        access@greenofig.com. We respond to all accessibility reports within 5 working days.
      </P>
    </SimplePage>
  )
}
