...
export const metadata: Metadata = {
  ...
  description:
    'Open roles at Greenofig. Join Nutritionist Coach Rawan Othman and the coaching team building the most personal, science-led nutrition platform in the region.',
